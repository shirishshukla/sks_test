...
class appd_agent(
  ...
  # Linux                       
  String $app_install_binary             = 'AppServerAgent-4.5.17.28908.zip',
  String $machine_install_binary         = 'machineagent-bundle-64bit-linux-4.5.16.2357.zip',
  String $base_appd_dir                  = '/opt/appdynamics',
  String $app_install_dir                = "${base_appd_dir}/app-agent",
  String $app_agent_owner                = 'appd',
  String $app_agent_group                = 'appd',
  String $machine_install_dir            = "${base_appd_dir}/machine-agent",
